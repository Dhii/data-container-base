...
class CreateNotFoundExceptionCapableTraitTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Data\Container\CreateNotFoundExceptionCapableTrait';
    ...
    /**
     * Tests that the `_createNotFoundException()` method works as expected.
     *
     * @since [*next-version*]
     */
    public function testCreateContainerException()
    {
        ...
        try {
            ...
            $this->assertEquals($key, $e->getDataKey(), 'Wrong key retrieved');
